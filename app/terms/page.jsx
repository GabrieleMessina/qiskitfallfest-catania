                    ...
                    <div className='mt-5'>
                      ...
                      <div className='m-5'>
                        <ul className='list-decimal'>
                            ...
                            <li className='hover:bg-white hover:text-black'>You accept the <Link target='blank' href={'https://docs.quantum.ibm.com/open-source/code-of-conduct'} className='font-bold underline text-[#9D5CFD]'>Qiskit Code of Conduct.</Link></li>
